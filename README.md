...
- **Database Management:** SQL data warehousing, data modelling (star schema design; fact & dimension tables), OLAP query optimization, MySQL & PostgreSQL administration
